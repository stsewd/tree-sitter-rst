...
#define CHARS_INLINE_MARKUP_LENGTH 3
const int32_t CHARS_INLINE_MARKUP[CHARS_INLINE_MARKUP_LENGTH] = {'*', '`', '|'};

#define CHARS_INLINE_MARKUP_DOUBLE_LENGTH 2
const int32_t CHARS_INLINE_MARKUP_DOUBLE[CHARS_INLINE_MARKUP_DOUBLE_LENGTH] = {'*', '`'};
