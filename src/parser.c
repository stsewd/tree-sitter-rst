...
enum {
  ...
  sym_emphasis = 27,
  sym_strong = 28,
  sym_interpreted_text = 29,
  sym_literal = 30,
  sym_substitution_reference = 31,
  sym__inline_target = 32,
  sym_footnote_reference = 33,
  sym_reference = 34,
  ...
  sym_field = 49,
  sym_option_list = 50,
  sym_option_list_item = 51,
  sym__explicit_markup_block = 52,
  sym__markup_block = 53,
  sym_footnote = 54,
  sym_citation = 55,
  sym_target = 56,
  sym__anonymous_target = 57,
  sym_directive = 58,
  sym_substitution_definition = 59,
  sym__embed_directive = 60,
  sym_comment = 61,
  sym__line = 62,
  sym__inline_markup = 63,
  aux_sym_document_repeat1 = 64,
  aux_sym_paragraph_repeat1 = 65,
  aux_sym__list_block_repeat1 = 66,
  aux_sym_bullet_list_repeat1 = 67,
  aux_sym_bullet_list_repeat2 = 68,
  aux_sym_enumerated_list_repeat1 = 69,
  aux_sym_field_list_repeat1 = 70,
  aux_sym_option_list_repeat1 = 71,
  aux_sym_option_list_repeat2 = 72,
  aux_sym__explicit_markup_block_repeat1 = 73,
  aux_sym__line_repeat1 = 74,
  alias_sym_field_body = 75,
  alias_sym_title = 76,
};
...
static const char *ts_symbol_names[] = {
  ...
  [sym__transition_marker] = "_transition_marker",
...
static TSSymbol ts_symbol_map[] = {
  ...
  [sym__transition_marker] = sym__transition_marker,
...
enum {
  ...
  ts_external_token__transition_marker = 4,
  ts_external_token__char_bullet = 5,
  ts_external_token__numeric_bullet = 6,
  ts_external_token_field_name = 7,
  ts_external_token__text = 8,
  ts_external_token_emphasis = 9,
  ts_external_token_strong = 10,
  ts_external_token_interpreted_text = 11,
  ts_external_token_literal = 12,
  ts_external_token_substitution_reference = 13,
  ts_external_token__inline_target = 14,
  ts_external_token_footnote_reference = 15,
  ts_external_token_reference = 16,
  ts_external_token_standalone_hyperlink = 17,
  ts_external_token__explicit_markup_start = 18,
};
...
static TSSymbol ts_external_scanner_symbol_map[EXTERNAL_TOKEN_COUNT] = {
  ...
  [ts_external_token__transition_marker] = sym__transition_marker,
...
static bool ts_external_scanner_states[16][EXTERNAL_TOKEN_COUNT] = {
  [1] = {
    ...
    [ts_external_token__transition_marker] = true,
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym__transition_marker] = ACTIONS(1),
  ...
  [1] = {
    ...
    [sym__transition_marker] = ACTIONS(17),
  ...
  [2] = {
    ...
    [sym__transition_marker] = ACTIONS(44),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_transition, 2),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_transition, 2),
