...
static const char *ts_symbol_names[] = {
  ...
  [alias_sym_list_bullet] = "list_bullet",
...
static TSSymbol ts_symbol_map[] = {
  ...
  [alias_sym_list_bullet] = alias_sym_list_bullet,
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__bullet_list_item] = STATE(13),
    [sym_enumerated_list] = STATE(3),
    [sym__enumerated_list_item] = STATE(10),
    [sym__numeric_bullet] = STATE(19),
    [sym_line] = STATE(7),
    [sym__blank_line] = STATE(3),
    [aux_sym_document_repeat1] = STATE(3),
    [aux_sym_paragraph_repeat1] = STATE(7),
    [aux_sym_bullet_list_repeat1] = STATE(8),
    [aux_sym_enumerated_list_repeat1] = STATE(6),
  ...
  [2] = {
    ...
    [sym__bullet] = ACTIONS(17),
    [aux_sym__numeric_bullet_token1] = ACTIONS(20),
    [aux_sym__numeric_bullet_token2] = ACTIONS(20),
    [aux_sym__numeric_bullet_token3] = ACTIONS(20),
    [aux_sym_line_token1] = ACTIONS(23),
    [sym__whitespace] = ACTIONS(26),
    [sym__eol] = ACTIONS(29),
  },
  [3] = {
    [sym__body_elements] = STATE(2),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.count = 1, .reusable = false}, SHIFT(18),
  [13] = {.count = 1, .reusable = true}, SHIFT(3),
  [15] = {.count = 1, .reusable = true}, REDUCE(aux_sym_document_repeat1, 2),
  [17] = {.count = 2, .reusable = true}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(16),
  [20] = {.count = 2, .reusable = true}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(23),
  [23] = {.count = 2, .reusable = false}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(17),
  [26] = {.count = 2, .reusable = false}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(18),
  [29] = {.count = 2, .reusable = true}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(2),
  [32] = {.count = 1, .reusable = true}, REDUCE(sym_document, 1),
  [34] = {.count = 1, .reusable = true}, SHIFT(2),
  [36] = {.count = 1, .reusable = true}, REDUCE(aux_sym_enumerated_list_repeat1, 2),
  [38] = {.count = 2, .reusable = true}, REDUCE(aux_sym_enumerated_list_repeat1, 2), SHIFT_REPEAT(23),
  [41] = {.count = 1, .reusable = false}, REDUCE(aux_sym_enumerated_list_repeat1, 2),
  [43] = {.count = 1, .reusable = true}, REDUCE(aux_sym_paragraph_repeat1, 2),
  [45] = {.count = 2, .reusable = false}, REDUCE(aux_sym_paragraph_repeat1, 2), SHIFT_REPEAT(17),
  [48] = {.count = 1, .reusable = false}, REDUCE(aux_sym_paragraph_repeat1, 2),
  [50] = {.count = 1, .reusable = true}, REDUCE(sym_enumerated_list, 1),
  [52] = {.count = 2, .reusable = true}, REDUCE(sym_enumerated_list, 1), SHIFT(23),
  [55] = {.count = 1, .reusable = false}, REDUCE(sym_enumerated_list, 1),
  [57] = {.count = 1, .reusable = true}, REDUCE(sym_paragraph, 1),
  [59] = {.count = 2, .reusable = false}, REDUCE(sym_paragraph, 1), SHIFT(17),
  [62] = {.count = 1, .reusable = false}, REDUCE(sym_paragraph, 1),
  [64] = {.count = 1, .reusable = true}, REDUCE(sym_bullet_list, 1),
  [66] = {.count = 2, .reusable = true}, REDUCE(sym_bullet_list, 1), SHIFT(16),
  [69] = {.count = 1, .reusable = false}, REDUCE(sym_bullet_list, 1),
  [71] = {.count = 1, .reusable = true}, REDUCE(aux_sym_bullet_list_repeat1, 2),
  [73] = {.count = 2, .reusable = true}, REDUCE(aux_sym_bullet_list_repeat1, 2), SHIFT_REPEAT(16),
  [76] = {.count = 1, .reusable = false}, REDUCE(aux_sym_bullet_list_repeat1, 2),
  [78] = {.count = 1, .reusable = true}, REDUCE(aux_sym_enumerated_list_repeat1, 1, .production_id = 1),
  [80] = {.count = 1, .reusable = false}, REDUCE(aux_sym_enumerated_list_repeat1, 1, .production_id = 1),
  [82] = {.count = 1, .reusable = true}, REDUCE(sym__bullet_list_item, 2, .production_id = 2),
  [84] = {.count = 1, .reusable = false}, REDUCE(sym__bullet_list_item, 2, .production_id = 2),
  [86] = {.count = 1, .reusable = true}, REDUCE(sym__enumerated_list_item, 2, .production_id = 2),
  [88] = {.count = 1, .reusable = false}, REDUCE(sym__enumerated_list_item, 2, .production_id = 2),
  [90] = {.count = 1, .reusable = true}, REDUCE(aux_sym_bullet_list_repeat1, 1, .production_id = 1),
  [92] = {.count = 1, .reusable = false}, REDUCE(aux_sym_bullet_list_repeat1, 1, .production_id = 1),
  [94] = {.count = 1, .reusable = true}, REDUCE(sym_line, 2),
  [96] = {.count = 1, .reusable = false}, REDUCE(sym_line, 2),
  ...
  [112] = {.count = 2, .reusable = true}, REDUCE(aux_sym_line_repeat1, 2), SHIFT_REPEAT(20),
  [115] = {.count = 1, .reusable = true}, REDUCE(aux_sym_line_repeat1, 2),
  ...
  [124] = {.count = 1, .reusable = true}, REDUCE(sym__numeric_bullet, 1),
};
